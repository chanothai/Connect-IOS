...
private extension PasswordContainerView {
    ...
    func configureVibrancyEffect() {
        ...
        if isVibrancyEffect {
            ...
            titleColor = whiteColor
            //dot view
            strokeColor = UIColor(colorLiteralRed: 136/255, green: 152/255, blue: 174/255, alpha: 1)
            fillColor = UIColor(colorLiteralRed: 136/255, green: 152/255, blue: 174/255, alpha: 1)
            //input view
            circleBackgroundColor = clearColor
